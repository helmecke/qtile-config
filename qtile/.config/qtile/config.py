...
keys = [
    ...
    Key([mod, ctrl], "Down", lazy.group.next_window()),
    Key([mod, ctrl], "k", lazy.group.prev_window()),
    Key([mod, ctrl], "Up", lazy.group.prev_window()),
    Key([mod], "h", lazy.layout.shrink_master()),
    Key([mod], "Left", lazy.layout.shrink_master()),
    Key([mod], "l", lazy.layout.grow_master()),
    Key([mod], "Right", lazy.layout.grow_master()),
    ...
    **layout_defaults,
    float_rules=[
        ...
        *layout.Floating.default_float_rules,
        ...
        Match(title="Cisco AnyConnect Secure Mobility Client"),
